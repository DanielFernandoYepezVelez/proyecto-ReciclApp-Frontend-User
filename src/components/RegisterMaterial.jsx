...
class RegisterMaterial extends React.Component{
    constructor(props) {
      ...
      async componentDidMount() {
        ...
        axios.get('https://proyecto-reciclapp-backend.herokuapp.com/api/material/typeMaterials', {
            headers: {
                token: `${token}`
            }
    ...
    onSubmit = async(eventObject) => {
        ...
        const token = getJwt();
        axios.post('https://proyecto-reciclapp-backend.herokuapp.com/api/material/createMaterial', {
