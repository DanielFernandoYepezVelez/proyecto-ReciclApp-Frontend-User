...
class Schedule extends React.Component {
  ...
  async componentDidMount() {
    ...
    axios.get('https://proyecto-reciclapp-backend.herokuapp.com/api/schedule/locations', {
        headers: {
            token: `${token}`
        }
    ...
    onSubmit = async(/* eventObject */) => {
      ...
      axios.post('https://proyecto-reciclapp-backend.herokuapp.com/api/schedule/date', {
    ...
    onSubmitTwo = async(/* eventObject */) => {
      ...
      axios.post('https://proyecto-reciclapp-backend.herokuapp.com/api/schedule/location', {
        location_id: this.state.location
       },
       {
        headers: {
